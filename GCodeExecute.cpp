...
/*
 * Putting this here because nowhere better to put it.
 *
 * Was running into an issue earlier where ld.exe couldn't find a __dso_handle
 * Turns out someone else ran into the exact same issue:
 * https://stackoverflow.com/a/48256026
 * */

#include "GCodeExecute.h"

void GCodeExecuteClass::Init(std::vector<String>* gCodeQueue)
{
...
std::vector<KeyValue> GCodeExecuteClass::getKeyValues(String code) {
	String splitWord = "";
